...
$(function () {
    $(".button_1").mouseenter(function () {//鼠标滑入明星系列
        ...
        $(".headershow").slideDown(200)//明星系列下拉菜单
        $(".headershow1").slideUp(20)//明星系列合上下拉菜单
        $(".headershow2").slideUp(20)//技术服务合上下拉菜单
    })
    $(".headershow").mouseleave(function () {//鼠标滑出明星系列
    ...
    $(".button_2").mouseenter(function () {//鼠标滑入产品一览
        ...
        $("#img_pre").attr("src", "img/theme-dark-logo.png");//logo图片变更
        $(".headershow1").slideDown(200)//产品一览下拉菜单
        $(".headershow").slideUp(20)//明星系列合上下拉菜单
        $(".headershow2").slideUp(20)//技术服务合上下拉菜单
    })
    $(".headershow1").mouseleave(function () {//鼠标滑出产品一览
        $(".header").removeClass("show")//给header删除class名
        $("#img_pre").attr("src", "img/theme-bright-logo.png");//logo图片变更
    ...
    $(".button_3").mouseenter(function () {//鼠标滑入技术服务
        $(".header").addClass("show")////给header添加一个class名
        $("#img_pre").attr("src", "img/theme-dark-logo.png");//logo图片变更
        $(".headershow2").slideDown(200)///技术服务下拉菜单
        $(".headershow").slideUp(20)//明星系列合上下拉菜单
        $(".headershow1").slideUp(20)//技术服务合上下拉菜单
    })
    $(".headershow2").mouseleave(function () {//鼠标滑出技术服务
        $(".header").removeClass("show")//给header删除class名
        $("#img_pre").attr("src", "img/theme-bright-logo.png");//logo图片变更
        $(".headershow2").slideUp(20)//技术服务合上下拉菜单
    })
    $(".header").mouseleave(function() {//鼠标滑出技术服务
        $(".header").removeClass("show")//给header删除class名
        $(".headershow").slideUp(20)///技术服务合上下拉菜单
        $(".headershow1").slideUp(20)//明星系列合上下拉菜单
        $(".headershow2").slideUp(20)//技术服务合上下拉菜单
    })
})
...
$(window).scroll(function () {
    ...
    if (scroH > 650) {
        $("div.nav0").addClass("fixed")
        $("div.nav0 li").addClass("fixed0")
        $("div.nav0 img").addClass("fixed1")
    } else {
        $("div.nav0").removeClass("fixed")
        $("div.nav0 li").removeClass("fixed0")
        $("div.nav0 img").removeClass("fixed1")
    }
})

// 导航变换图片
$(function () {
    $("div.nav0 li").mouseenter(function () {
        var i = $(this).index();
    ...
    $("div.nav0 li").mouseleave(function () {
        var i = $(this).index();
